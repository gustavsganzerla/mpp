...
SECRET_KEY = 'django-insecure-n3p_de=lyf_-iq7v#=b^zp4d2p7e#5$vni3lfpj%t$n#&0fwi7'
...
INSTALLED_APPS = [
    'protein_profiler.apps.ProteinProfilerConfig',
...
RECAPTCHA_PUBLIC_KEY = '6LfDFSUqAAAAAPYeITTMm4aieaSAkI7xSVc6PaKU'
RECAPTCHA_PRIVATE_KEY = '6LfDFSUqAAAAACk66KCIVnlLO6SKSGWhte71YcoK'